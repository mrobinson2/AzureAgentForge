...
Multi-tenant implementation (the [`experimental/multi-tenant/`](experimental/multi-tenant/) design). More chat surfaces. A fuller observability pipeline (distributed tracing, SLO burn-rate alerts) building on the v1.2 alert rules + workbook.
